...
namespace VehicleRentalServices
{
    public partial class DisplayOwnerRegister : Form
    {
        ...
        {
            InitializeComponent();
            if (Database.allowRegisterOwner == false) button1.Enabled = false;
        }
        ...
        private void ClickRegister(object sender, EventArgs e)
        {
            if (CheckToRegister())
            {
                ...
                Owner owner = new Owner(textBox1.Text, textBox2.Text, dateTimePicker1.Value, textBox3.Text, dateTimePicker2.Value);
            ...
            else
            {
                ...
                TextChangedBusinessName(sender, e);
            }
        }
        ...
        private void MouseClickBusinessName(object sender, MouseEventArgs e)
        {
            TextChangedBusinessName(sender, e);
        }
    }
